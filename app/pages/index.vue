<template>
    <div>
        <div id="hero" class="relative w-full bg-secondary overflow-hidden">
            <!-- The Image: No repeat, custom height, covers the width -->
            <img :src="hero" alt="Hero Background" class="absolute top-20 left-0 w-full max-h-[80%] object-cover -z-0" />

            <section class="relative h-[70vh] min-h-[500px] text-white flex items-center justify-center z-10">

                <!-- Animated Overlay: Matches the full section height to blend the image into the background -->
                <div class="absolute inset-0 bg-secondary/80 animate-fade-in z-0"></div>
